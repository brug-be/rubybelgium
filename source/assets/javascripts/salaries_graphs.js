...
function drawCharts () {
  ...
  thirdChartQuery.setQuery('select G, avg(H) group by G order by avg(H) DESC label G "City", avg(H) "Average Salary"');
...
function handlefirstChartQueryResponse (response) {
  ...
  var options = {
    ...
    colors: ['#ebaaab', '#dd6f71', '#BD2628'], // The colors to use for the chart elements
    fontName: 'Roboto',
...
function handlethirdChartQueryResponse (response) {
  ...
  var options = {
    ...
    // colors: ['#000000', '#ffbf00', '#c40000'], // The colors to use for the chart elements
    colors: ['#BD2628','#dd6f71','#ebaaab'], // The colors to use for the chart elements
    fontName: 'Roboto',
    fontSize: 14, // The default font size of all text in the chart, in pixels
    vAxis: {
      format: 'currency'
